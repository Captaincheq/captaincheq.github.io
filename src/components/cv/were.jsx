    ...
    <div className="resume">
      <div className="base">
        <div className="profile">
          <div>
            <a className="photo" href="index.html">
              <img src="images/photo.jpg" alt="Alec Mabhiza Chirawu" />
            </a>
          </div>
          <div className="info">
            <h4 className="name">NAME:</h4>
            <small className="job">Alec Mabhiza Chirawu</small>
          </div>
        </div>
        ...
        <div className="follow">
          ...
          <div className="box">
            ...
            <a href="" target="_blank" rel="noreferrer"><i className="fa fa-steam"></i></a>
            ...
            <a href="" target="_blank" rel="noreferrer"><i className="fa fa-reddit-alien"></i></a>
          </div>
        </div>
      </div>
